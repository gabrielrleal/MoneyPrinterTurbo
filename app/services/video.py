...
from app.services.presets import get_preset, RenderContext
...
def combine_videos(
    ...
    audio_file: str,
    preset_name: str = "sequential",
    wiki_overlay_image: str | None = None,
    ...
    logger.info(f"edit preset: {preset_name}")
